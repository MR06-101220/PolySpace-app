...
object PdfGenerator {
    ...
    fun generateTimetablePdf(context: Context, courses: List<DraftCourse>, weekStart: java.time.LocalDate, studentName: String): File? {
        ...
        val textPaint = Paint().apply { color = Color.DKGRAY; textSize = 45f; typeface = Typeface.DEFAULT_BOLD }
        val timePaint = Paint().apply { color = Color.GRAY; textSize = 35f; textAlign = Paint.Align.RIGHT }
